# 树
## For Elysia
 ![Elysia_NoB](vx_images/309701119236656.png =500x)   
### ---------------------------------------------------

#### 二叉树的前序遍历
![](vx_images/432331219256822.png =1000x)
##### 知识点

>前序遍历

* 前序遍历首先访问 **根节点** ，然后遍历 **左子树** ，最后遍历 **右子树** 。
![前序遍历二叉树 ](vx_images/555223319249491.gif =700x)
    ...
    vector<int> preorderTraversal(TreeNode *root)
    {
        ...
        while (!stk.empty() || node != nullptr) //当栈不为空或者node不指向nullptr
        {
            while (node != nullptr) //先遍历左子树，在遍历的过程中载入节点到栈和容器中
            {
                ...
                stk.emplace(node); //在栈当前位置的上一个位置插入(即栈顶)
                node = node->left;
            }
...
![](vx_images/301672311248790.gif =700x)

![](vx_images/276211818230365.jpg =700x)
#### 二叉树的中序遍历
![](vx_images/485101610248790.png =1000x)
...
![](vx_images/399711111236657.png =700x)
* 流程：
* 
```cpp
** F --> B --> A --> nullLeft
...
![](vx_images/500721818248791.jpg =700x)
#### 二叉树的后序遍历
##### 知识点
* 先遍历左子树
* 然后遍历右子树
...
![](vx_images/191241918236658.jpg)

#### 二叉树的层序遍历
![](vx_images/352934511230366.png =1000x)

##### 知识点
>何为层序遍历

*将每一层的元素 **从左到右** 依次加入数组
![](vx_images/190391614249494.jpg =700x)
...
![](vx_images/443451614246049.gif =700x)
...
* 深度优先搜索实质上是将二叉树摆成阶梯型
![](vx_images/582210014248792.jpg =700x)
* 它的遍历规则是：
...
![](vx_images/438731514256825.gif =700x)

#### 二叉树的最大深度
![](vx_images/559060715241803.png =700x)
...
#### 对称二叉树
![](vx_images/464480212230367.png =1000x)
...
#### 路径总和
![](vx_images/245293514230367.png =700x)
##### 深度优先搜索DFS[递归]
###### 做法一
```cpp
// 路径总和
...
#### 从中序与后序遍历序列构造二叉树
![](vx_images/226535020230368.png =700x)
##### 递归
```cpp
#include <iostream>
#include <vector>
...
![](vx_images/591185020248794.png =500x)
...
#### 从中序与前序遍历序列构造二叉树
![](vx_images/279152919230370.png =700x)
##### 递归
```cpp
    unordered_map<int,int> myMap();
    int preIndex;
...
#### 填充每个节点的下一个右侧节点指针
![](vx_images/345432819230371.png =700x)
...
![](vx_images/544875019236664.png =500x)
#### 填充每个节点的下一个右侧节点指针Ⅱ
![](vx_images/386433619248797.png =700x)
...
#### 二叉树的最近公共祖先
![](vx_images/276210716230372.png =700x)
...
#### 二叉树的序列化与反序列化
![](vx_images/497685119248798.png =700x)
